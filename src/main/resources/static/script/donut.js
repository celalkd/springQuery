...
;(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    //
    var insideRatingValue = 0;
    //
    for (var i = 0, len = data.length; i < len; i++){
      segmentTotal += data[i].value;
      //
      if(data[i].value>insideRatingValue)
          insideRatingValue = data[i].value;
      //
    ...
    function drawDoughnutText(animationDecimal, segmentTotal){
      $summaryNumber
        ...
        .text((insideRatingValue * animationDecimal).toFixed(1));
    }
